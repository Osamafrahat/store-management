export const translations = {
  en: {
    ...
    'backup.restoreConfirm': 'Restore from {file}? This will overwrite current data.',
    'backup.deleteConfirm': 'Delete {file}?',
  ...
  ar: {
    ...
    'backup.delete': 'حذف',
    'backup.restoreConfirm': 'استعادة من {file}؟ سيؤدي هذا إلى الكتابة فوق البيانات الحالية.',
    'backup.deleteConfirm': 'حذف {file}؟',
